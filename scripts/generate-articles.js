...
npx eslint --fix .`,
    ...
    faq: [
      ...
      { q: "How do you manage team communications?", a: "Encourage asynchronous communications (like Slack updates) over high-frequency video calls." }
    ]
  }
};

// Fallback generator for remaining posts to ensure we get all 39 covered
const categoriesMap = {
