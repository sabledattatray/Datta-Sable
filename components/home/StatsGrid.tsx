...
import { BarChart3, Database, BookOpen, Zap, LucideIcon } from 'lucide-react';
...
const stats: Stat[] = [
  ...
  { value: 300, suffix: '+', label: 'Technical Resources', code: 'PUB-CNT', icon: Database },
    ...
    <section className="section" style={{ background: 'var(--surface2)', padding: '3rem 0', position: 'relative', overflow: 'hidden' }}>
      ...
      <div className="container relative z-10">
        <div className="flex flex-col gap-8 mb-20">
          <TechLabel>PUBLICATION METRICS</TechLabel>
          ...
          <div className="max-w-2xl">
            ...
            <p className="mt-4" style={{ color: 'var(--muted)', fontSize: '1rem', maxWidth: '480px', lineHeight: 1.6, fontFamily: "'Inter', sans-serif" }}>
              Tracking article coverage, tool catalog growth, and educational tutorials published weekly.
            </p>
          </div>
        </div>
