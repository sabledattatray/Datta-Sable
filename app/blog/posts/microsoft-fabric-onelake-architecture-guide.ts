...
<p style="margin-bottom: 1.25rem; line-height: 1.75; color: var(--muted); font-size: 1.05rem;">PBI["📊 Power BI <a href="/blog/power-bi-direct-lake-performance-tuning-fabric" class="autolink" style="color: var(--accent); text-decoration: underline;" title="Direct Lake performance tuning guide">Direct Lake</a>\\nSub-second queries"]</p>
