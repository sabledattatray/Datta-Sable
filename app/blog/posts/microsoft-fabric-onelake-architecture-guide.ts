...
<p style="margin-bottom: 1.25rem; line-height: 1.75; color: var(--muted); font-size: 1.05rem;">All compute in Fabric (Spark, SQL, Data Factory, Power BI refreshes) consumes <strong>Capacity Units (CUs)</strong> from the <a href="/blog/microsoft-fabric-pricing-guide-2026" class="autolink" style="color: var(--accent); text-decoration: underline;" title="Fabric capacity planning">Fabric capacity</a> assigned to the workspace. CU consumption is the primary cost lever.</p>
