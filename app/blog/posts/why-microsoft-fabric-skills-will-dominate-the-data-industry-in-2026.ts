...
<p>Direct Lake mode eliminates this trade-off. Because OneLake stores data in Delta Parquet format, Power BI can read these parquet files directly from OneLake storage into memory on the fly. There are no data copies, no import schedules, and no DirectQuery translation overhead. You get the sub-second performance of Import Mode with the real-time freshness of DirectQuery, completely free of the data copy tax.</p>
...
<div class="overflow-x-auto my-8">
  <table style="width: 100%; border-collapse: collapse; border: 1px solid var(--border); font-size: 0.9rem;">
    ...
    <tbody>
      <tr style="border-bottom: 1px solid var(--border);">
        <td style="padding: 12px; border-right: 1px solid var(--border); font-weight: bold; color: var(--accent);">DP-600 (Analytics Engineer)</td>
      ...
      <tr style="border-bottom: 1px solid var(--border);">
        <td style="padding: 12px; border-right: 1px solid var(--border); font-weight: bold; color: var(--accent);">DP-700 (Data Engineer)</td>
