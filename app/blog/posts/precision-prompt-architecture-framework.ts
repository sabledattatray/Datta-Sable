...
<div class="featured-snippet" style="background: rgba(201, 243, 29, 0.03); padding: 1.5rem; border-left: 4px solid var(--accent); border-radius: 0 8px 8px 0; margin-bottom: 2rem;">
      ...
      <p>A production <a href="/tools/ai-prompt-generator" class="autolink" style="color: var(--accent); text-decoration: underline;" title="prompt optimization utility">prompt</a> is composed of modular, read-only system configurations and dynamic runtime variables. A standard template layout organizes information in a strict top-down hierarchy:</p>
