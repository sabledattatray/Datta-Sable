...
<p style="margin-bottom: 1.25rem; line-height: 1.7; color: var(--muted);"><strong>Architecture, at a glance.</strong> Fabric is delivered entirely as SaaS. There is no virtual machine to provision, no Spark cluster to size, and no storage account to configure — Microsoft operates the compute fabric underneath, and you consume it through a capacity (an <a href="/blog/microsoft-fabric-pricing-guide-2026" class="autolink" style="color: var(--accent); text-decoration: underline;" title="Microsoft Fabric Pricing Guide">F-SKU</a>) that you assign to one or more workspaces. Every item you create inside a workspace — a lakehouse, a warehouse, a pipeline, a notebook, a Power BI report — writes its data into OneLake using the open Delta Parquet format, which is the same format used by Apache Spark and Databricks. That single decision is what allows a Spark notebook, a T-SQL warehouse, and a Power BI semantic model to all read the exact same physical files without anyone copying anything between them. For a deep-dive into OneLake's internal architecture, Shortcuts, Mirroring, security model, and Direct Lake query flow, see our <a href="/blog/microsoft-fabric-onelake-architecture-guide" style="color: var(--accent); text-decoration: underline;">complete OneLake Architecture Guide</a>.</p>
...
<p style="margin-bottom: 1.25rem; line-height: 1.7; color: var(--muted);"><strong>Certification relevance.</strong> <a href="/blog/dp-600-study-guide-2026" class="autolink" style="color: var(--accent); text-decoration: underline;" title="DP-600 Study Guide">DP-600</a> and DP-700 both open with foundational questions on what Fabric is and how its SaaS model differs from IaaS/PaaS Azure analytics services — this is consistently the first knowledge domain tested.</p>
...
<p style="margin-bottom: 1.25rem; line-height: 1.7; color: var(--muted);"><strong>Certification relevance.</strong> OneLake fundamentals — what it is, how Shortcuts work, and the difference between a OneLake-native table and a Shortcut — are core to both <a href="/blog/dp-600-study-guide-2026" class="autolink" style="color: var(--accent); text-decoration: underline;" title="Fabric Analytics Engineer exam preparation">DP-600</a> and DP-700, and increasingly appear as scenario-based questions rather than simple definitions. For comprehensive exam preparation on this topic, our <a href="/blog/microsoft-fabric-onelake-architecture-guide" style="color: var(--accent); text-decoration: underline;">OneLake Architecture Guide</a> covers all the exam-relevant topics: Delta Lake internals, V-Order, Shortcuts, Mirroring, Direct Lake fallback behaviour, security, and governance.</p>
  ...
  <table style="width: 100%; border-collapse: collapse; border: 1px solid var(--border); font-size: 0.9rem;">
    ...
    <tbody>
      ...
      <tr style="border-bottom: 1px solid var(--border);">
        ...
        <td style="padding: 12px; border-right: 1px solid var(--border); color: var(--muted);">The compute pool (<a href="/blog/microsoft-fabric-pricing-guide-2026" class="autolink" style="color: var(--accent); text-decoration: underline;" title="Fabric capacity planning">F-SKU</a>) a workspace is assigned to</td>
...
<p style="margin-bottom: 1.25rem; line-height: 1.7; color: var(--muted);"><strong>Enterprise recommendation.</strong> Data Factory is one of the most heavily tested topics in the <a href="/blog/dp-600-vs-dp-700-vs-dp-800-microsoft-fabric-certification-comparison" class="autolink" style="color: var(--accent); text-decoration: underline;" title="DP-700 Certification Guide">DP-700</a> certification exam — if you're studying for that path specifically, our <a href="/blog/dp-700-study-guide-2026" class="text-[var(--accent)] hover:underline transition-colors">DP-700 Study Guide</a> walks through the pipeline activity types and orchestration patterns the exam leans on most.</p>
...
<p style="margin-bottom: 1.25rem; line-height: 1.7; color: var(--muted);"><strong>Certification relevance.</strong> <a href="/blog/dp-600-vs-dp-700-vs-dp-800-microsoft-fabric-certification-comparison" class="autolink" style="color: var(--accent); text-decoration: underline;" title="Fabric Data Engineer certification details">DP-700</a> (Fabric Data Engineer Associate).</p>
...
<p style="margin-bottom: 1.25rem; line-height: 1.7; color: var(--muted);"><strong>Certification relevance.</strong> Central to DP-600; increasingly intersects with DP-800 where Warehouse tables are extended with AI/vector capabilities.</p>
