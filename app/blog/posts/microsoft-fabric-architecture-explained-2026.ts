...
<p style="margin-bottom: 1.25rem; line-height: 1.7; color: var(--muted);"><strong>Certification relevance.</strong> OneLake fundamentals — what it is, how Shortcuts work, and the difference between a OneLake-native table and a Shortcut — are core to both DP-600 and DP-700, and increasingly appear as scenario-based questions rather than simple definitions.</p>
