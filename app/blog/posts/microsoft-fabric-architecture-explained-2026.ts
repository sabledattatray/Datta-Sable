...
<p style="margin-bottom: 1.25rem; line-height: 1.7; color: var(--muted);"><strong>Certification relevance.</strong> Core to <a href="/blog/dp-600-vs-dp-700-vs-dp-800-microsoft-fabric-certification-comparison" class="autolink" style="color: var(--accent); text-decoration: underline;" title="Fabric Data Engineer certification details">DP-700</a> (Data Engineer) and present in DP-600 (Analytics Engineer) for how Lakehouse Gold tables feed semantic models.</p>
...
<ol style="list-style-type: decimal; padding-left: 1.5rem; margin-bottom: 1.25rem; color: var(--muted); line-height: 1.7;">
  ...
  <li style="margin-bottom: 0.5rem;">Build a hands-on <a href="/blog/microsoft-fabric-medallion-architecture-guide" class="autolink" style="color: var(--accent); text-decoration: underline;" title="Medallion architecture bronze-silver-gold framework">medallion pipeline</a>: Bronze ingestion → Silver transformation → Gold serving.</li>
