...
<p style="margin-bottom: 1.25rem; line-height: 1.7; color: var(--muted);"><strong>Performance impact.</strong> Copy activities scale with parallelism settings (Degree of Copy Parallelism) and source system throughput limits, not just <a href="/blog/microsoft-fabric-pricing-guide-2026" class="autolink" style="color: var(--accent); text-decoration: underline;" title="Fabric capacity planning">Fabric capacity</a> size — undersized parallelism is a more common bottleneck than capacity size in ingestion-heavy workloads.</p>
...
<p style="margin-bottom: 1.25rem; line-height: 1.7; color: var(--muted);"><strong>Certification relevance.</strong> Core to DP-700 (Data Engineer) and present in <a href="/blog/dp-600-study-guide-2026" class="autolink" style="color: var(--accent); text-decoration: underline;" title="Fabric Analytics Engineer exam preparation">DP-600</a> (Analytics Engineer) for how Lakehouse Gold tables feed semantic models.</p>
...
<ul style="list-style-type: disc; padding-left: 1.5rem; margin-bottom: 1.25rem; color: var(--muted); line-height: 1.7;">
  ...
  <li style="margin-bottom: 0.5rem;"><strong>Data Engineer</strong> — owns ingestion pipelines, Spark transformation, <a href="/blog/microsoft-fabric-medallion-architecture-guide" class="autolink" style="color: var(--accent); text-decoration: underline;" title="Medallion architecture bronze-silver-gold framework">medallion architecture</a>, and Real-Time Intelligence. DP-700-aligned.</li>
