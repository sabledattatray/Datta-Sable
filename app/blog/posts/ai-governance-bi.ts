...
<div class="breadcrumb-container" style="font-family: monospace; font-size: 0.8rem; margin-bottom: 2rem; color: var(--muted); border-bottom: 1px solid var(--border); padding-bottom: 1rem;">
  ...
  <span style="color: var(--text);">Ethical AI: Implementing Governance for LLM-Driven Insights</span>
</div>
<!-- BREADCRUMB_END -->
...
def log_compliance_event(user_id: int, query: str, output: str) -&gt; None:
    ...
    with open('compliance_audit.log', 'a') as f:
      ...
      <ul style="list-style-type: disc; padding-left: 1.5rem; margin-bottom: 2rem; line-height: 1.7; color: var(--muted);">
        <li><strong>Mask</strong> sensitive PII columns before passing data payloads to LLM APIs.</li><li><strong>Audit</strong> LLM query results against database records to catch <a href="/glossary/ai-hallucination-risks" class="glossary-term-link" title="The phenomenon where a Large Language Model generates information that is factually incorrect or logically inconsistent." data-definition="The phenomenon where a Large Language Model generates information that is factually incorrect or logically inconsistent." style="color: var(--accent); border-bottom: 1px dashed var(--accent); text-decoration: none; cursor: help;">hallucinations</a>.</li><li><strong>Set</strong> alert alerts for queries requesting unauthorized data tables.</li><li><strong>Maintain</strong> detailed data lineage records for all AI-generated reports.</li>
      </ul>
